...
function ButtonNavBar() {
  return (
    <div className="btm-nav btm-nav-sm w-96 m-auto rounded-3xl bottom-5 shadow-xl">
      <button className="border-e-2 border-e-gray-800/10 rounded-s-3xl hover:bg-gray-800/5">
        <MdPersonOutline className="text-3xl text-gray-600" />
      </button>
      <button className="border-e-2 border-e-gray-800/10 hover:bg-gray-800/5">
        <MdOutlineLocalOffer className="text-3xl text-gray-600" />
      </button>
      <button className="rounded-e-3xl hover:bg-gray-800/5">
